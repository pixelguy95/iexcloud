...
type Quote struct {
	...
	OddLotDelayedPriceTime EpochTime `json:"oddLotDelayedPriceTime,omitempty"`
	...
	IEXOpenTime            EpochTime `json:"iexOpenTime,omitempty"`
	IEXClose               float64   `json:"iexClose,omitempty"`
	IEXCloseTime           EpochTime `json:"iexCloseTime,omitempty"`
	...
	LastTradeTime          EpochTime `json:"lastTradeTime,omitempty"`
